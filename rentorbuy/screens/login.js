...
console.log(responseJson.reviews);
  ...
  render(){
    ...
    <View style={styles.container}>
      ...
      <Text style={{position:'relative',fontSize:60,marginTop:'20%', textAlign:'center', color:'#00487C', fontFamily:'FuturaH'}}>Login</Text>
      ...
      <Text style={{position:'relative',fontSize:20,margin:'auto', textAlign:'center', color:'#FFF', fontFamily:'FuturaH', marginTop:'15%', backgroundColor:'#00487C', padding:'5%', width:'70%', borderRadius:10, alignSelf:'center', elevation:1}} onPress={()=>this.props.navigation.navigate('Where')}>LOGIN</Text>
